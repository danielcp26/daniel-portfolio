    ...
    <div className="min-h-screen">
      ...
      <section id="work" className="py-24 px-6 bg-[#F8F8F8]">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <div className="mb-16">
              <p className="text-xs tracking-[0.2em] uppercase text-black/40 mb-4">SELECTED WORK</p>
              <h2 className="text-4xl md:text-5xl font-light text-black">Featured Projects (3)</h2>
            </div>
          </ScrollReveal>
      ...
      <section className="py-24 px-6 bg-[var(--bg)]">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <div className="mb-12">
              <p className="text-xs tracking-[0.2em] uppercase text-white/40 mb-4">EXPERIENCE</p>
              <h2 className="text-4xl md:text-5xl font-light text-white">Worked with</h2>
            </div>
          </ScrollReveal>
